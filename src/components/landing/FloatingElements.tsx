  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Floating social icons.
          Hidden below md: these are positioned as a percentage of the width,
          so on a phone they land on top of the headline and make it unreadable
          — and the target market reads this page on a phone. They are purely
          decorative (the container is pointer-events-none), so there is
          nothing to lose by not drawing them there. */}
      <div className="hidden md:block absolute top-32 right-[15%] animate-float-slow" style={{ animationDelay: '0s' }}>
      ...
      <div className="hidden md:block absolute top-48 left-[12%] animate-float" style={{ animationDelay: '0.5s' }}>
      ...
      <div className="hidden md:block absolute top-64 right-[25%] animate-float-rotate" style={{ animationDelay: '1s' }}>
      ...
      <div className="hidden md:block absolute bottom-40 right-[10%] animate-float-slow" style={{ animationDelay: '1.5s' }}>
      ...
      <div className="hidden md:block absolute bottom-60 left-[8%] animate-float" style={{ animationDelay: '2s' }}>
      ...
      <div className="hidden md:block absolute top-80 left-[20%] animate-float-rotate" style={{ animationDelay: '2.5s' }}>
      ...
      {/* Decorative shapes */}
      <div className="hidden md:block absolute top-1/4 right-[5%] w-4 h-4 bg-primary/40 rounded-full animate-bounce-subtle" style={{ animationDelay: '0.3s' }} />
      <div className="hidden md:block absolute top-1/3 left-[5%] w-3 h-3 bg-accent/50 rounded-full animate-bounce-subtle" style={{ animationDelay: '0.6s' }} />
      <div className="hidden md:block absolute bottom-1/4 right-[20%] w-5 h-5 bg-primary/30 rounded-full animate-bounce-subtle" style={{ animationDelay: '0.9s' }} />
      <div className="hidden md:block absolute bottom-1/3 left-[15%] w-4 h-4 bg-accent/40 rounded-full animate-bounce-subtle" style={{ animationDelay: '1.2s' }} />
