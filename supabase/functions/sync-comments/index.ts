...
// Match the concrete client createClient(url, key) actually returns; the
// bare ReturnType<typeof createClient> resolves to a never-schema client that
// no real client is assignable to.
